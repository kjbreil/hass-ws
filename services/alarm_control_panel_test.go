...
func TestAlarmControlPanelAlarmArmAway_JSON(t *testing.T) {
	...
	tests := []struct {
		...
		fields: NewAlarmControlPanelAlarmArmAway(Targets("climate.kitchen"), &AlarmControlPanelAlarmArmAwayParams{Code: &code}),
		name:   "base",
...
func TestAlarmControlPanelAlarmArmCustomBypass_JSON(t *testing.T) {
	...
	tests := []struct {
		...
		fields: NewAlarmControlPanelAlarmArmCustomBypass(Targets("climate.kitchen"), &AlarmControlPanelAlarmArmCustomBypassParams{Code: &code}),
		name:   "base",
...
func TestAlarmControlPanelAlarmArmHome_JSON(t *testing.T) {
	...
	tests := []struct {
		...
		fields: NewAlarmControlPanelAlarmArmHome(Targets("climate.kitchen"), &AlarmControlPanelAlarmArmHomeParams{Code: &code}),
		name:   "base",
...
func TestAlarmControlPanelAlarmArmNight_JSON(t *testing.T) {
	...
	tests := []struct {
		...
		fields: NewAlarmControlPanelAlarmArmNight(Targets("climate.kitchen"), &AlarmControlPanelAlarmArmNightParams{Code: &code}),
		name:   "base",
...
func TestAlarmControlPanelAlarmArmVacation_JSON(t *testing.T) {
	...
	tests := []struct {
		...
		fields: NewAlarmControlPanelAlarmArmVacation(Targets("climate.kitchen"), &AlarmControlPanelAlarmArmVacationParams{Code: &code}),
		name:   "base",
...
func TestAlarmControlPanelAlarmDisarm_JSON(t *testing.T) {
	...
	tests := []struct {
		...
		fields: NewAlarmControlPanelAlarmDisarm(Targets("climate.kitchen"), &AlarmControlPanelAlarmDisarmParams{Code: &code}),
		name:   "base",
...
func TestAlarmControlPanelAlarmTrigger_JSON(t *testing.T) {
	...
	tests := []struct {
		...
		fields: NewAlarmControlPanelAlarmTrigger(Targets("climate.kitchen"), &AlarmControlPanelAlarmTriggerParams{Code: &code}),
		name:   "base",
